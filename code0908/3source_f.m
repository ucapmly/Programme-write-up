...
save dataf3_1.txt v_data1 -ascii
save dataf3_2.txt v_data2 -ascii
save dataf3_3.txt v_data3 -ascii
...
sen=[d1;d2;d3;d4]
sensorlong=sen(:)
save sen_dataf_3.txt sensorlong -ascii


free=sensor_data(1:128,1:256)
free_long=free(:)
save free_dataf_3.txt free_long -ascii
