...
function additional_loss(phi, θ , p)
    return 10*sum(abs2, phi[1](var_snapshot_t1, θ.depvar.u).-u_1)/length(u_1)+10*sum(abs2, phi[1](var_snapshot_t2, θ.depvar.u).-u_2)/length(u_2)+10*sum(abs2, phi[1](var_snapshot_t3, θ.depvar.u).-u_3)/length(u_3)
end
